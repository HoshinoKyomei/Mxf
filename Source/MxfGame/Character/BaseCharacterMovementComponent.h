...
MXFGAME_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Gameplay_MovementStopped);

/**
 * FBaseCharacterGroundInfo
 *
 *	Information about the ground under the character.  It only gets updated as needed.
 */
USTRUCT(BlueprintType)
struct FBaseCharacterGroundInfo
{
	GENERATED_BODY()
...
public:
	...
	const FBaseCharacterGroundInfo& GetGroundInfo();
...
protected:
	...
	FBaseCharacterGroundInfo CachedGroundInfo;
