...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FBaseHealth_DeathEvent, AActor*, OwningActor);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_FourParams(FBaseHealth_AttributeChanged, UBaseHealthComponent*, HealthComponent, float, OldValue, float, NewValue, AActor*, Instigator);
...
public:
	...
	UPROPERTY(BlueprintAssignable)
	FBaseHealth_DeathEvent OnDeathStarted;
...
protected:
	...
	UFUNCTION()
	virtual void OnRep_DeathState(EBaseDeathState OldDeathState);
...
protected:
	...
	UPROPERTY()
	TObjectPtr<const UBaseHealthSet> HealthSet;

	// Replicated state used to handle dying.
	UPROPERTY(ReplicatedUsing = OnRep_DeathState)
	EBaseDeathState DeathState;
};
