...
#include "BaseVerbMessageHelpers.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BaseVerbMessageHelpers)

//////////////////////////////////////////////////////////////////////
// FBaseVerbMessage

FString FBaseVerbMessage::ToString() const
{
	FString HumanReadableMessage;
	FBaseVerbMessage::StaticStruct()->ExportText(/*out*/ HumanReadableMessage, this, /*Defaults=*/ nullptr, /*OwnerObject=*/ nullptr, PPF_None, /*ExportRootScope=*/ nullptr);
...
APlayerState* UBaseVerbMessageHelpers::GetPlayerStateFromObject(UObject* Object)
{
...
APlayerController* UBaseVerbMessageHelpers::GetPlayerControllerFromObject(UObject* Object)
{
	if (APlayerController* PC = Cast<APlayerController>(Object))
	{
		return PC;
...
FGameplayCueParameters UBaseVerbMessageHelpers::VerbMessageToCueParameters(const FBaseVerbMessage& Message)
{
...
FBaseVerbMessage UBaseVerbMessageHelpers::CueParametersToVerbMessage(const FGameplayCueParameters& Params)
{
	FBaseVerbMessage Result;
